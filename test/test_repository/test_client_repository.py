...
class ClientRepositoryTestCase(unittest.TestCase):
    ...
    def test_get_all(self):
        ...
        expected_db_response = [{
            ...
            'client_tax_condition': expected_client.tax_condition.get_name('RESPONSABLE INSCRIPTO'),
    ...
    def test_create(self):
        ...
        expected_values = (
            ...
            client_to_create.tax_condition.get_name('RESPONSABLE INSCRIPTO'),
    ...
    def test_save(self):
        ...
        expected_values = (
            ...
            client_to_modify.tax_condition.get_name('RESPONSABLE INSCRIPTO'),
